...
|----------|--------|----------|
| **CI Lab (Python)** | [![CI Workflow](https://github.com/NicholasAMartinez/Group-3-Nick/actions/workflows/ci.yml/badge.svg)](https://github.com/NicholasAMartinez/Group-3-Nick/actions/workflows/ci.yml) | ![Coverage](https://img.shields.io/endpoint?url=https://gist.githubusercontent.com/NicholasAMartinez/<YOUR_GIST_ID>/raw/coverage.json) |
